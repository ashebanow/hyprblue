...
# TODO: do this at first run (or boot, worst case).
# Copy .desktop file and icons into standard locations
...
#         xdg-desktop-menu install --mode system --novendor ./resources/1password.desktop
#     else
#         install -m0644 ./resources/1password.desktop /usr/share/applications
#     fi
# fi
# if [ -d /usr/share/icons ]; then
#     cp -rf ./resources/icons/* /usr/share/icons/
